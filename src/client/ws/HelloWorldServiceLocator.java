...
public class HelloWorldServiceLocator extends org.apache.axis.client.Service implements client.ws.HelloWorldService {
    ...
    private java.lang.String HelloWorld_address = "http://localhost:8080/webserviceaxisDemo_war_exploded/services/HelloWorld";
    @Override
    ...
    @Override
    public client.ws.HelloWorld_PortType getHelloWorld() throws javax.xml.rpc.ServiceException {
    ...
    @Override
    public client.ws.HelloWorld_PortType getHelloWorld(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            client.ws.HelloWorldSoapBindingStub _stub = new client.ws.HelloWorldSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (client.ws.HelloWorld_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                client.ws.HelloWorldSoapBindingStub _stub = new client.ws.HelloWorldSoapBindingStub(new java.net.URL(HelloWorld_address), this);
                _stub.setPortName(getHelloWorldWSDDServiceName());
                return _stub;
            }
        }
